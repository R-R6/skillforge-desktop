...
contextBridge.exposeInMainWorld("skillforge", {
  ...
  migrateDataDirectory: (directoryPath: string) => ipcRenderer.invoke("storage:migrate-data-directory", directoryPath) as Promise<import("../shared/storage").DataDirectoryMigrationResult | null>,
  cleanPreviousDataDirectory: () => ipcRenderer.invoke("storage:clean-previous-data-directory") as Promise<{ removedPath: string; freedBytes: number } | null>,
  dismissPreviousDataDirectory: () => ipcRenderer.invoke("storage:dismiss-previous-data-directory") as Promise<import("../shared/storage").StorageSummary>,
